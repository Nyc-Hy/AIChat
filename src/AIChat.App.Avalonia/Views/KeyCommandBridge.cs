...
// 3-step pattern three times for ⌘⇧C (/copy), ⌘G (/git), and ⌘/
// (/help): call SlashCommandHandler.TryExecuteAsync, drop the
...
internal static class KeyCommandBridge
{
    ...
    // flavour — /git and /help land as "系统" bubbles (read-only
