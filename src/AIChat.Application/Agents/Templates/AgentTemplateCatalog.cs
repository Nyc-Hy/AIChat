    ...
    public static IReadOnlyList<AgentTemplate> CreateDefaults()
    {
        ...
        [
            ...
            new AgentTemplate
            {
                ...
                DefaultToolIds = ["list_files", "search_text", "read_file", "read_input_artifact", "git_status", "git_diff"],
                DefaultToolPermissionModes = AutoReadOnly(["list_files", "search_text", "read_file", "read_input_artifact", "git_status", "git_diff"]),
                CanWrite = false,
                CanVerify = false,
            ...
            new AgentTemplate
            {
                ...
                DefaultToolIds = ["read_file", "read_input_artifact", "search_text", "apply_patch", "edit_file", "write_file", "git_status", "git_diff"],
                DefaultToolPermissionModes = Merge(
                    AutoReadOnly(["read_file", "read_input_artifact", "search_text", "git_status", "git_diff"]),
            ...
            new AgentTemplate
            {
                ...
                DefaultToolIds = ["read_file", "read_input_artifact", "search_text", "run_build", "run_test", "git_status", "git_diff"],
                DefaultToolPermissionModes = Merge(
                    AutoReadOnly(["read_file", "read_input_artifact", "search_text", "git_status", "git_diff"]),
            ...
            new AgentTemplate
            {
                ...
                DefaultToolIds = ["read_file", "read_input_artifact", "search_text", "git_status", "git_diff"],
                DefaultToolPermissionModes = AutoReadOnly(["read_file", "read_input_artifact", "search_text", "git_status", "git_diff"]),
                CanWrite = false,
                CanVerify = false,
